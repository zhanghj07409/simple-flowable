...
FLOWABLE.APP_URL = {
    ...
    getAccountUrl: function () {
        return FLOWABLE.CONFIG.contextRoot + '/app/rest/getaccount';
    },
    ...
    getProcessInstanceModelJsonUrl: function (modelId) {
        return FLOWABLE.CONFIG.contextRoot + '/app-api/rest/process-instances/' + modelId + '/model-json';
    },

    getProcessInstanceModelJsonHistoryUrl: function (historyModelId) {
        return FLOWABLE.CONFIG.contextRoot + '/app-api/rest/process-instances/history/' + historyModelId + '/model-json';
    },
