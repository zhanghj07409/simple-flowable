...
flowableModeler
  ...
  .config(['$provide', '$routeProvider', '$selectProvider', '$translateProvider', function ($provide, $routeProvider, $selectProvider, $translateProvider) {
    ...
    $routeProvider
        .when('/processes', {
            templateUrl: appResourceRoot + 'workflow/manage/views/processes.html',
            controller: 'ProcessesCtrl'
        })
        .when('/processes/:modelId', {
            templateUrl: appResourceRoot + 'workflow/manage/views/process.html',
        ...
        .when('/casemodels', {
            templateUrl: appResourceRoot + 'workflow/manage/views/casemodels.html',
            controller: 'CaseModelsCtrl'
        })
        .when('/casemodels/:modelId', {
            templateUrl: appResourceRoot + 'workflow/manage/views/casemodel.html',
            controller: 'CaseModelCtrl'
        })
        .when('/forms', {
            templateUrl: appResourceRoot + 'workflow/manage/views/forms.html',
            controller: 'FormsCtrl'
        })
        .when('/forms/:modelId', {
            templateUrl: appResourceRoot + 'workflow/manage/views/form.html',
            controller: 'FormCtrl'
        })
        ...
        .when('/decision-tables', {
            templateUrl: appResourceRoot + 'workflow/manage/views/decision-tables.html',
            controller: 'DecisionTablesController'
        })
        .when('/decision-tables/:modelId', {
            templateUrl: appResourceRoot + 'workflow/manage/views/decision-table.html',
        ...
        .when('/apps', {
            templateUrl: appResourceRoot + 'workflow/manage/views/app-definitions.html',
            controller: 'AppDefinitionsCtrl'
        })
        .when('/apps/:modelId', {
            templateUrl: appResourceRoot + 'workflow/manage/views/app-definition.html',
            controller: 'AppDefinitionCtrl'
        })
        .when('/apps/:modelId/history/:modelHistoryId', {
            templateUrl: 'workflow/manage/views/app-definition.html',
            controller: 'AppDefinitionCtrl'
        })
        .when('/editor/:modelId', {
            templateUrl: appResourceRoot + 'workflow/manage/editor-app/editor.html',
            controller: 'EditorController'
        })
        .when('/form-editor/:modelId', {
            templateUrl: appResourceRoot + 'workflow/manage/views/form-builder.html',
        ...
        .when('/decision-table-editor/:modelId', {
            templateUrl: appResourceRoot + 'workflow/manage/views/decision-table-editor.html',
            controller: 'DecisionTableEditorController'
        })
        .when('/app-editor/:modelId', {
            templateUrl: appResourceRoot + 'workflow/manage/views/app-definition-builder.html',
  ...
  .run(['$rootScope', '$timeout', '$modal', '$translate', '$location', '$http', '$window', 'appResourceRoot',
        function($rootScope, $timeout, $modal, $translate, $location, $http, $window, appResourceRoot) {
            ...
            $rootScope.setMainPage = function(mainPage) {
                $rootScope.mainPage = mainPage;alert($rootScope.mainPage.path);
