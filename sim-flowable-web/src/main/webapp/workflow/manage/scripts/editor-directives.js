...
angular.module('flowableModeler').directive('formBuilderElement', ['$rootScope', '$timeout', '$modal', '$http', '$templateCache', '$translate', 'RecursionHelper', 'FormBuilderService',
    ...
    return {
        restrict: 'AE',
        templateUrl: 'workflow/manage/views/templates/form-builder-element-template.html',
        transclude: false,
        scope: {
        ...
        link: function ($scope, $element, attributes) {
            ...
            var templateUrl = 'workflow/manage/views/popover/formfield-edit-popover.html';
