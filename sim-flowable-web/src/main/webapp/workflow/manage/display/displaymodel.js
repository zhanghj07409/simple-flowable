...
if (modelType == 'runtime') {
    if (historyModelId) {
        modelUrl = FLOWABLE.CONFIG.contextRoot + '/app-api/rest/process-instances/history/' + historyModelId + '/model-json';
    } else {
        modelUrl = FLOWABLE.CONFIG.contextRoot + '/app-api/rest/process-instances/' + modelId + '/model-json';
    }
    ...
    modelUrl = FLOWABLE.CONFIG.contextRoot + '/app-api/rest/process-definitions/' + processDefinitionId + '/model-json';
}
