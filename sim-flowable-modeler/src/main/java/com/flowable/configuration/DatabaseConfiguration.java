...
public class DatabaseConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory() {
        ...
        try {
            ...
            properties.load(this.getClass().getClassLoader().getResourceAsStream("com/flowable/properties/" + databaseType + ".properties"));

            sqlSessionFactoryBean.setConfigurationProperties(properties);
            sqlSessionFactoryBean.setMapperLocations(ResourcePatternUtils.getResourcePatternResolver(resourceLoader).getResources("classpath*:/META-INF/*-mybatis-mappings/*.xml"));
