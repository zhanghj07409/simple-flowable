...
public class FlowableClientService {
    ...
    public CloseableHttpClient getHttpClient(ServerConfig serverConfig) {
        return getHttpClient(serverConfig.getUserName(), serverConfig.getPassword());
    }
    ...
    public JsonNode executeRequest(HttpUriRequest request, ServerConfig serverConfig, int expectedStatusCode) {
        return executeRequest(request, serverConfig.getUserName(), serverConfig.getPassword(), expectedStatusCode);
    }
    ...
    public JsonNode executeDownloadRequest(HttpUriRequest request, HttpServletResponse httpResponse, ServerConfig serverConfig, int expectedStatusCode) {
        return executeDownloadRequest(request, httpResponse, serverConfig.getUserName(), serverConfig.getPassword(), expectedStatusCode);
    }
    ...
    public AttachmentResponseInfo executeDownloadRequest(HttpUriRequest request, ServerConfig serverConfig, Integer... expectedStatusCodes) {
        return executeDownloadRequest(request, serverConfig.getUserName(), serverConfig.getPassword(), expectedStatusCodes);
    }
    ...
    public ResponseInfo execute(HttpUriRequest request, ServerConfig serverConfig, int... expectedStatusCodes) {
        return execute(request, serverConfig.getUserName(), serverConfig.getPassword(), expectedStatusCodes);
    }
    ...
    public void execute(HttpUriRequest request, HttpServletResponse httpResponse, ServerConfig serverConfig) {
        execute(request, httpResponse, serverConfig.getUserName(), serverConfig.getPassword());
    }
    ...
    public HttpPost createPost(String uri, ServerConfig serverConfig) {
        ...
        post.setHeader("Cookie" , "SESSION=" + RequestContextHolder.getRequestAttributes().getSessionId());
        return post;
    }
    ...
    public HttpPut createPut(String uri, ServerConfig serverConfig) {
        ...
        put.setHeader("Cookie" , "SESSION=" + RequestContextHolder.getRequestAttributes().getSessionId());
        return put;
    }
    ...
    public HttpGet createGet(ServerConfig serverConfig, String uri){
        HttpGet get = new HttpGet(this.getServerUrl(serverConfig, uri));
