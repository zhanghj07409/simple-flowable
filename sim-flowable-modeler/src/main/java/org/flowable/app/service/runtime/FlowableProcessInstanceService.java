...
public class FlowableProcessInstanceService {
    ...
    public ProcessInstanceRepresentation startNewProcessInstanceByKey(String processDefinitionKey,String businessKey, Map<String,Object> variables){
        ...
        if(variables != null) {
            ...
            if(variables.get("businessinfo")!=null){
                //业务信息获取
                businessmap = (Map<String, Object>) variables.get("businessinfo");
                //清除临时变量值
                variables.remove("businessinfo");
            }
     ...
     */
    public void deleteProcessInstance(String processInstanceId,Map<String,Object> params) {
     ...
     * @param processInstanceId
     */
    public void deleteProcessInstanceStrictly(String processInstanceId, Map<String,Object> params){
