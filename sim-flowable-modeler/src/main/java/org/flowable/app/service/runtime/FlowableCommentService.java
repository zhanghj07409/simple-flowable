...
public class FlowableCommentService {
    ...
    public ResultListGridDataEntity getTaskComments(String taskId) {
        ...
        return new ResultListGridDataEntity(commentList);
    }
    ...
    public ResultListGridDataEntity getProcessInstanceComments(String processInstanceId) {
