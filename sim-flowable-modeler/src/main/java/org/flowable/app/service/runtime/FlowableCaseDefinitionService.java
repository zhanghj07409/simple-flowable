...
public class FlowableCaseDefinitionService {
    ...
    public ResultListGridDataEntity getCaseDefinitions(Boolean latest, String deploymentKey) {
        ...
        if (deploymentKey != null) {
            ...
            if (deployment != null) {
                ...
                return new ResultListGridDataEntity(new ArrayList<CaseDefinitionRepresentation>());
            }
        ...
        ResultListGridDataEntity result = new ResultListGridDataEntity(convertDefinitionList(definitions));
        return result;
    }
