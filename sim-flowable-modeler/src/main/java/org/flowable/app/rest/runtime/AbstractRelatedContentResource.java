...
import org.flowable.app.service.component.SimpleContentTypeMapper;
...
public abstract class AbstractRelatedContentResource {
    ...
    public ResultListGridDataEntity getContentItemsForTask(String taskId) {
    ...
    public ResultListGridDataEntity getContentItemsForProcessInstance(String processInstanceId) {
    ...
    protected ResultListGridDataEntity createResultRepresentation(List<ContentItem> results) {
        ...
        ResultListGridDataEntity result = new ResultListGridDataEntity(resultList);
